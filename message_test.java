...
public class message_test {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String CSV_file = "C:\\Users\\Developer\\Desktop\\Bootcamp_msg\\test_message.csv";
		String outpath = "C:\\Users\\Developer\\Desktop\\Bootcamp_msg\\test_message_output2.csv";
...
myloop:		for(int i=0;i<1;i++){
		...
		/*     boolean b1;
			  ...
			  Thread.sleep(120000);//2 mins waiting time due to alert from meetup
